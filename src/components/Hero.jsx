function MosaicShapes() {
  return (
    <g className="hero__mosaic">
      ...
      <path d="M0 0h130a130 130 0 0 1-130 130Z" fill="#c97882" />
      <path d="M130 0h130v130A130 130 0 0 1 130 0Z" fill="#f6f2ef" />
      <rect x="260" width="260" height="130" fill="#842433" />
      ...
      <rect x="130" y="130" width="130" height="130" fill="#c97882" />
      ...
      <circle cx="520" cy="195" r="65" fill="#c97882" />

      <rect y="260" width="260" height="130" fill="#e6b9be" />
      <path d="M0 260a130 130 0 0 1 130 130H0Z" fill="#842433" />
      <path d="M130 260a130 130 0 0 1 130 130H130Z" fill="#f6f2ef" />
      <rect x="260" y="260" width="260" height="130" fill="#c97882" />
      <circle cx="390" cy="325" r="65" fill="#e6b9be" />

      <rect y="390" width="130" height="130" fill="#f6f2ef" />
      <circle cx="65" cy="455" r="65" fill="#c97882" />
      <rect x="130" y="390" width="130" height="130" fill="#842433" />
      <path d="M130 390a130 130 0 0 1 130 130H130Z" fill="#c97882" />
      <rect x="260" y="390" width="130" height="130" fill="#f6f2ef" />
      <path d="M260 520a130 130 0 0 1 130-130v130Z" fill="#e6b9be" />
      ...
      <path d="M0 650a130 130 0 0 1 130-130v130Z" fill="#f6f2ef" />
      <rect x="260" y="520" width="260" height="130" fill="#842433" />
      <path d="M260 520a130 130 0 0 1 130 130H260Z" fill="#c97882" />
      <path d="M390 650a130 130 0 0 1 130-130v130Z" fill="#e6b9be" />
      ...
      <circle cx="195" cy="705" r="55" fill="#c97882" />
      <rect x="260" y="650" width="260" height="110" fill="#c97882" />
      <path d="M260 650a130 130 0 0 1 130 110H260Z" fill="#842433" />
    </g>
  )
}
  ...
  return (
    <section className="hero" aria-labelledby="page-title">
      ...
      <div className="hero__panel" aria-hidden="true">
        <svg className="hero__art hero__art--desktop" width="520" height="760" viewBox="0 0 520 760">
          <MosaicShapes />
        </svg>
        <svg className="hero__art hero__art--compact" viewBox="0 260 520 130" preserveAspectRatio="xMidYMid meet">
          <MosaicShapes />
        </svg>
      </div>
    </section>
